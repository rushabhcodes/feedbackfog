    ...
    <>
      <main className="flex flex-col flex-grow items-center justify-center px-4 py-12 md:px-24">
        ...
        <Carousel
          ...
          className="w-full max-w-md shadow-xl rounded-lg overflow-hidden"
        >
          <CarouselContent>
        ...
        <div className="mt-8">
          <Button className="font-bold py-2 px-4 rounded shadow-lg hover:shadow-xl transition duration-200" ><Link href={"/dashboard"}>Go to Dashboard</Link></Button>
        </div>
      </main>
      <footer className="mt-24 text-center p-4 md:p-6 ">
